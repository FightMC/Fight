package deterno.fight.tgm.command;
...
import deterno.fight.tgm.TGM;
import deterno.fight.tgm.gametype.GameType;
import deterno.fight.tgm.map.MapContainer;
import deterno.fight.tgm.map.MapInfo;
import deterno.fight.tgm.match.MatchManager;
import deterno.fight.tgm.match.MatchStatus;
import deterno.fight.tgm.modules.ChatModule;
import deterno.fight.tgm.modules.countdown.Countdown;
import deterno.fight.tgm.modules.countdown.CycleCountdown;
import deterno.fight.tgm.modules.countdown.StartCountdown;
import deterno.fight.tgm.modules.team.MatchTeam;
import deterno.fight.tgm.modules.team.TeamManagerModule;
import deterno.fight.tgm.modules.team.TeamUpdateEvent;
import deterno.fight.tgm.user.PlayerContext;
...
public class CycleCommands {
    ...
    @Command(aliases = {"maps"}, desc = "View the maps that are on Fight, although not necessarily in the rotation.", usage = "[page]")
